    ...
    Type.Object(
      {
        ...
        receiverMappings: Type.Array(
          Type.Object({
            ...
            roles: Type.Optional(
              Type.Array(AlertmanagerRoleSchema, { description: "接收该告警的 SCOW 角色列表，运行时自动查询对应用户" }),
            ),
          }),
