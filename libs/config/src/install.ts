          ...
          Type.Object(
            {
              ...
              caCertPath: Type.String({
                description: "SCOWD CA根证书路径, 相对 config 的默认目录",
                default: "./scowd/certs/ca.crt",
              }),
          ...
          Type.Object(
            {
              ...
              caCertPath: Type.String({
                description: "适配器 CA根证书路径, 相对 config 的默认目录",
                default: "./adapter/certs/ca.crt",
              }),
              scowCertPath: Type.String({
    ...
    Type.Object(
      {
        ...
        novncClientImage: Type.String({
          description:
            "novnc客户端镜像地址，优先使用 novnc 配置中的novncClientImage，如果未配置 novnc 中的 novncClientImage，会在 portal 启动时使用此镜像地址",
          default: "ghcr.io/pkuhpc/novnc-client-docker:master",
        }),

        portMappings: Type.Optional(
          Type.Object({
            portalServer: Type.Optional(
    ...
    Type.Object(
      {
        ...
        novncClientImage: Type.String({
          description:
            "novnc客户端镜像，portal或AI启用时需要。如果portal下也同时配置novncClientImage，则忽略 portal中的配置，优先使用此处镜像地址",
          default: "ghcr.io/pkuhpc/novnc-client-docker:master",
        }),
      },
...
export function getInstallConfig(filePath: string, logger?: Logger) {
