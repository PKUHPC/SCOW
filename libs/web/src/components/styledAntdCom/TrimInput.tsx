...
export const TrimInput = React.forwardRef<InputRef, InputProps>(({ onBlur, onChange, value, ...rest }, ref) => {
  ...
  return <Input ref={ref} {...rest} value={value} onChange={onChange} onBlur={handleBlur} />;
});
