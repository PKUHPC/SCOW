import {
  FindDeviceOutputSchema,
  GetDeviceDetailInputSchema,
  GetDeviceDetailOutputSchema,
  GetDeviceStatusInputSchema,
  GetDeviceStatusOutputSchema,
  GetDeviceTopologyInputSchema,
  GetDeviceTopologyOutputSchema,
  GetRecommendedDevicesOutputSchema,
  UpdateChipIdInputSchema,
  UpdateChipIdOutputSchema,
...
export const device = router({
  findDevice: backendApiProcedure
    .meta({
      openapi: {
        method: "POST",
  ...
  getDeviceStatus: backendApiProcedure
    .meta({
      openapi: {
        method: "POST",
  ...
  getDeviceDetail: backendApiProcedure
    .meta({
      openapi: {
        method: "POST",
  ...
  getDeviceTopology: backendApiProcedure
    .meta({
      openapi: {
        method: "POST",
  ...
  updateChipId: backendApiProcedure
    .meta({
      openapi: {
        method: "PUT",
  ...
  getRecommendedDevices: backendApiProcedure
    .meta({
      openapi: {
        method: "GET",
