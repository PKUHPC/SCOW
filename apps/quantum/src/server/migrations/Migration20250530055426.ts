...
export class Migration20250530055426 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql("create table `quantum_job` (`id` int unsigned not null auto_increment primary key, `job_id` varchar(255) not null, `submit_time` datetime not null, `state` varchar(255) not null, `info` json not null, `user_id` varchar(255) not null, `last_sync_time` datetime not null) default character set utf8mb4 engine = InnoDB;");
    ...
    this.addSql("create table `user_token` (`id` int unsigned not null auto_increment primary key, `user_id` varchar(255) not null, `token` varchar(255) not null, `created_at` datetime not null) default character set utf8mb4 engine = InnoDB;");
