  ...
  pageComp: {
    ...
    app: {
      ...
      launchAppForm: {
        ...
        fileExtensionNotAllowed: "The file extension must be one of: {0}",
        create: "create",
        costPerHour: "Cost:",
        gpuCoresRequired: "Please enter the number of accelerator cards per node",
        templateButton: "Templates",
      ...
      advancedFileSelectModal: {
        ...
        directoryRequired: "Please select a folder",
        fileExtensionNotAllowed: "Please select a file with one of these extensions: {0}",
        select: "Select File",
        upload: "Upload File",
        mkdir: "Create Folder",
