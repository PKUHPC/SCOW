  ...
  pageComp: {
    ...
    job: {
      ...
      submitJobForm: {
        ...
        pathUnsafeCharacter: "路径不能包含空格、逗号或特殊字符",
        ...
        unavailableParamsTitle: "模板参数失效提醒",
        unavailableParamsDesc: "检测到该模板内部分参数已失效，无法正常使用，是否删除此模板？",
        unavailableParamsConfirm: "删除",
    ...
    submitJobCom: {
      ...
      ResourceConfigSection: {
        ...
        accountDebt: "账户余额不足",
        userQuotaExceeded: "用户已超出限额",
        clusterLabel: "集群",
        clusterUnauthorized: "当前账户未授权该集群",
        partitionLabel: "分区",
        qosLabel: "QOS",
        ...
        nodeCountOtherPlaceholder: "其他值",
        nodeCountExceedsMaxTooltip: "超过最大可选资源数",
        gpuCoresLabel: "单节点加速卡卡数",
        gpuCoresRequired: "请输入单节点加速卡卡数",
        cpuCoresLabel: "单节点CPU核心数",
        cpuCoresRequired: "请输入单节点CPU核心数",
        maxTimeLabel: "最长运行时间",
      ...
      templateListModal: {
        ...
        qos: "QOS",
        nodeCount: "节点数",
        cpuCoresPerNode: "单节点CPU核心数",
        gpuCoresPerNode: "单节点加速卡卡数",
        maxRuntime: "最长运行时间",
        command: "命令",
        loading: "加载中...",
        empty: "暂无模板",
    ...
    fileManagerComp: {
      ...
      uploadDirModal: {
        ...
        existedFileModalTitle: "替换文件",
        existedFileModalContent: "目标文件夹下已存在同名文件 {}，是否上传并替换该文件？",
        existedFileModalOk: "替换",
        existedDirModalTitle: "替换文件夹",
        existedDirModalContent: "目标文件夹下已存在同名文件夹{}，是否上传并替换该文件夹？",
        existedDirModalOk: "替换",
        existedModalCancel: "取消",
    ...
    app: {
      ...
      launchAppForm: {
        ...
        pathTraversal: "路径不能包含 ..",
        pathCurrentDirectory: "路径不能包含 .",
        absolutePathRequired: "路径必须以 / 开头",
        rootNotAllowed: "路径不能为根目录 (/)",
        fileExtensionNotAllowed: "文件扩展名必须是以下类型之一：{0}",
        create: "创建",
        costPerHour: "费用:",
        gpuCoresRequired: "请输入单节点加速卡卡数",
        templateButton: "模板",
      ...
      advancedFileSelectModal: {
        ...
        fileRequired: "请选择文件",
        directoryRequired: "请选择文件夹",
        fileExtensionNotAllowed: "请选择以下扩展名的文件：{0}",
        select: "选择文件",
        upload: "上传文件",
        mkdir: "新建文件夹",
        decompression: "解压文件",
