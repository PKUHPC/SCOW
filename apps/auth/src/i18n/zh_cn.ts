export default {
  login: {
    ...
    invalidVCode: "验证码错误，请重新输入",
    invalidInput: "用户名/密码无效，请检查",
    accountLocked: "账户已被锁定，请联系管理员",
    accountLockedTime1: "账户已被锁定",
    accountLockedTime2: "分钟，请稍后再试",
    invalidUserId: "用户ID不存在，请重新输入",
    invalidPasswordRemain: "密码错误，请重新输入，剩余",
    invalidPasswordRemainSuffix: "次机会",
    ...
    userNotFound: "用户不存在",
    userBlocked: "用户已被封锁",
    oidcUserNotFound1: "OIDC 登录用户 ",
    oidcUserNotFound2: " 在 SCOW 认证系统中不存在，请联系管理员创建用户，或使用原有用户名密码登录。",
    oidcUserBlocked1: "OIDC 登录用户 ",
    oidcUserBlocked2: " 已被封锁，无法登录，请联系管理员解锁，或使用原有用户名密码登录。",
    retryOidcLogin: "重试 OIDC 登录",
    useBuiltinLogin: "使用用户名密码登录",
