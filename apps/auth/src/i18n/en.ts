export default {
  login: {
    ...
    invalidVCode: "Incorrect verification code, please re-enter",
    ...
    invalidUserId: "User ID does not exist, please re-enter",
    invalidPasswordRemain: "Incorrect password, please re-enter, remaining ",
    invalidPasswordRemainSuffix: " attempts",
    invalidPassword: "Incorrect password, please re-enter",
