...
interface Props {
  selectItem: SummaryClusterInfo | PlatformOverview | undefined;
  loading: boolean;
  activeTabKey: string;
...
export const InfoPanes: React.FC<Props> = ({ selectItem, loading, activeTabKey, onTabChange, currentClusters }) => {
  ...
  return (
    <Card style={{ width: "100%" }} tabList={clusterCardsList} activeTabKey={activeTabKey} onTabChange={onTabChange}>
            ...
            <InfoPaneContainer>
              <InfoPane
                ...
                paneData={[
                  ...
                  { itemName: t(p("notAvailable")), num: notAvailableGpuCount || 0, color: colors.gpunotAvailable },
                ]}
              ></InfoPane>
            </InfoPaneContainer>
          </Col>
