export default {
  ...
  app: {
    ...
    jobs: {
      ...
      environmentVariableList: {
        ...
        notInHomeDir: "Working directory must be under the user's home directory or a trusted path",
      },
      mountPointList: {
        ...
        notInHomeDir: "Mount source path must be under the user's home directory or a trusted path",
  ...
  component: {
    ...
    fileSelectModal: {
      homeDirectory: "Home Directory",
      onlyHomeDir: "Operations are only allowed in the home directory or trusted directories",
