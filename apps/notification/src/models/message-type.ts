...
export const internalMessageTypesMap = new Map<InternalMessageType, MessageTypeInfo>([
  ...
  [InternalMessageType.AccountOverdue, {
    ...
    contentTemplate: {
      ...
      de: "Zum Zeitpunkt [{__time__}] hat das Konto {__accountName__} einen Rückstand von {__amount__} Yuan. "
        + "Bitte zahlen Sie rechtzeitig.",
      es: "A [{__time__}], la cuenta {__accountName__} tiene una deuda de {__amount__} yuanes. "
        + "Por favor pague a tiempo.",
      fr: "À [{__time__}], le compte {__accountName__} a une dette de {__amount__} yuan. "
        + "Veuillez payer rapidement.",
      ja: "[{__time__}] 現在、アカウント {__accountName__} は {__amount__} 元の未払いがあります。"
        + " 速やかにお支払いください。",
      ko: "[{__time__}] 기준, 계정 {__accountName__} 에 {__amount__} 위안의 연체가 있습니다. "
        + "빠른 납부를 부탁드립니다.",
      pt: "Em [{__time__}], a conta {__accountName__} possui atraso de {__amount__} yuan. "
        + "Por favor, pague o quanto antes.",
      ru: "На [{__time__}] по счёту {__accountName__} задолженность {__amount__} юаней. "
  ...
  [InternalMessageType.AccountRechargeSuccess, {
    ...
    contentTemplate: {
      ...
      de: "Das Konto {__accountName__} wurde am [{__time__}] um {__chargeAmount__} Yuan aufgeladen. "
        + "Aktueller Kontostand: {__amount__} Yuan.",
      es: "La cuenta {__accountName__} fue recargada con {__chargeAmount__} yuanes el [{__time__}]. "
        + "El saldo actual es {__amount__} yuanes.",
      fr: "Le compte {__accountName__} a été rechargé de {__chargeAmount__} yuan le [{__time__}]. "
        + "Le solde actuel est de {__amount__} yuan.",
      ja: "アカウント {__accountName__} は [{__time__}] に {__chargeAmount__} 元がチャージされました。"
        + " 現在の残高は {__amount__} 元です。",
      ko: "계정 {__accountName__} 는 [{__time__}] 에 {__chargeAmount__} 위안을 충전했습니다. "
        + "현재 잔액은 {__amount__} 위안입니다.",
      pt: "A conta {__accountName__} foi recarregada com {__chargeAmount__} yuan em [{__time__}]. "
        + "O saldo atual é {__amount__} yuan.",
      ru: "Счёт {__accountName__} пополнен на {__chargeAmount__} юаней в [{__time__}]. "
  ...
  [InternalMessageType.AccountLowBalance, {
    ...
    contentTemplate: {
      ...
      de: "Zum Zeitpunkt [{__time__}] beträgt der Kontostand von {__accountName__} weniger als 20 Yuan. "
        + "Bitte zahlen Sie rechtzeitig.",
      es: "A [{__time__}], el saldo de la cuenta {__accountName__} es inferior a 20 yuanes. "
        + "Por favor pague a tiempo.",
      fr: "À [{__time__}], le solde du compte {__accountName__} est inférieur à 20 yuan. "
        + "Veuillez payer rapidement.",
      ja: "[{__time__}] 時点で、アカウント {__accountName__} の残高は 20 元未満です。"
        + " 速やかにお支払いください。",
      ko: "[{__time__}] 기준, 계정 {__accountName__} 의 잔액은 20 위안 미만입니다. "
        + "빠른 납부를 부탁드립니다.",
      pt: "Em [{__time__}], o saldo da conta {__accountName__} é inferior a 20 yuan. "
        + "Por favor, pague em tempo.",
      ru: "На [{__time__}] баланс счёта {__accountName__} менее 20 юаней. "
        + "Пожалуйста, оплатите вовремя.",
  ...
  [InternalMessageType.AccountBalance, {
    ...
    contentTemplate: {
      ...
      fr: "Changement de solde du compte {__accountName__} : dépense de {__amount__}, "
  ...
  [InternalMessageType.AccountLocked, {
    ...
    contentTemplate: {
      ...
      de: "Das Konto {__accountName__} wurde am [{__time__}] gesperrt. "
        + "Bitte kontaktieren Sie den Administrator zur Entsperrung.",
      es: "La cuenta {__accountName__} fue bloqueada el [{__time__}]. "
        + "Puede contactar al administrador para solicitar el desbloqueo.",
      fr: "Le compte {__accountName__} a été bloqué le [{__time__}]. "
        + "Vous pouvez contacter l’administrateur pour demander le déblocage.",
      ja: "アカウント {__accountName__} は [{__time__}] にロックされました。"
        + " 管理者に連絡して解除を依頼できます。",
      ko: "계정 {__accountName__} 는 [{__time__}] 에 잠금되었습니다. "
        + "관리자에게 문의하여 해제를 요청하세요.",
      pt: "A conta {__accountName__} foi bloqueada em [{__time__}]. "
        + "Você pode contatar o administrador para solicitar o desbloqueio.",
      ru: "Счёт {__accountName__} был заблокирован в [{__time__}]. "
