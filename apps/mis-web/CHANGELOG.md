...
- c7877af: 将账户"主管理员"角色统一重命名为"主管理员"
- c576348: 账户管理下的添加用户时，姓名增加必填校验
...
- 79278d5: 账户/用户信息同步结果增加成功数据及失败详情的展示
...
- d1a71d4: 账户管理下的用户管理切换不刷新 bug 修复
- 79278d5: 管理系统平台管理员可配置启用 shell 的 root 权限
- 9bb1fa3: 在门户/管理系统/AI 中扩展获取未读消息 metadata 类型包括对象及数组
- 79278d5: 登录用户在管理的账户下移出自己或取消自己的管理员权限时，账户管理导航下不允许再访问该账户相关信息
...
- 5144723: 管理系统的租户管理和平台管理中的账户列表新增主管理员姓名或 id 搜索项
...
- 1227c7347: 修复导入用户时账户选择默认主管理员提交无效问题
...
- f5e1d45ab: 管理系统导入账户时, 在没有主管理员的情况下账户主管理员默认选择账户的第一个用户
...
- 977600e34: 修复了一个 bug，该 bug 曾导致分页情况下导入的账户没有主管理员
