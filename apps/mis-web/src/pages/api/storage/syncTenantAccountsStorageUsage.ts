...
export const SyncTenantAccountsStorageUsageSchema = typeboxRouteSchema({
  method: "POST",
...
export default /* #__PURE__*/route(SyncTenantAccountsStorageUsageSchema, async (req, res) => {
  ...
  const logInfo = {
    ...
    operationTypeName: OperationType.syncTenantAccountsStorageUsage,
  ...
  return await asyncClientCall(client, "syncTenantAccountsStorageUsage", {
    storageId, tenant: info.tenant,
  })
    .then(async () => {
