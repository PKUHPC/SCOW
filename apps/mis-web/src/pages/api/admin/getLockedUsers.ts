...
export default /* #__PURE__*/ typeboxRoute(GetLockedUsersSchema, async (req, res) => {
  ...
  return await getLockedUsers(runtimeConfig.AUTH_INTERNAL_URL, { identityId: userId, name }, console)
    .then(async (res) => {
      return {
        200: {
          results: res || [],
