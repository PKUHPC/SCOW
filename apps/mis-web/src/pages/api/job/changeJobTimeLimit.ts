...
export default /* #__PURE__*/ route(ChangeJobTimeLimitSchema, async (req, res) => {
  ...
  const { jobAccessible } = await checkJobAccessible({
    ...
    info,
    limitMinutes,
    allowUserAndAccountAdminChangeJobTimeLimit: publicConfig.CHANGE_JOB_LIMIT.allowUserAndAccountAdmin,
  });
