...
export const ClusterSyncResultDrawer: React.FC<Props> = ({ item, onClose, open, t, title }) => {
  ...
  return (
    <Drawer width={500} placement="right" onClose={onClose} open={open} title={title}>
      <Collapse defaultActiveKey={["success", "failed"]}>
...
const SyncDetailsDescription: React.FC<{
  ...
  <Descriptions column={1} bordered size="small">
    {Object.entries(data).map(([label, value], index) => (
      <Descriptions.Item key={index} label={label} labelStyle={{ width: "30%", verticalAlign: "top" }}>
