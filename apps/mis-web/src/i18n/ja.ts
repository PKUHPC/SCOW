...
export default {
  common: {
    ...
    edit: "編集",
    idOrName: "ユーザーID/氏名",
    accountOwnerId: "アカウント所有者ID",
    accountOwnerName: "アカウント所有者名",
    HPCAI: "HPC&AI",
    quantum: "量子",
  ...
  pageComp: {
    ...
    admin: {
      ...
      ImportUsersTable: {
        selectAccount: "アカウントを選択してください！",
        specifyOwner: "各アカウントの所有者を指定してください。",
    ...
    user: {
      ...
      userTable: {
        ...
        blockedExplanation: "ブロック済み：ユーザーはアカウント管理者またはアカウント所有者によりブロックされており、ジョブ提出時にこのアカウントを選択できません。",
  ...
  component: {
    ...
    deleteModals:{
      ...
      accountsOwnerPrompt: "ユーザー <b>{}</b> はアカウント <b>{}</b> の所有者です。" +
      ...
      ownerIdRequired:"アカウント所有者IDを入力してください",
      invalidAccountNameOrOwnerId: "入力したアカウント名または所有者IDが一致しません。",
      confirmPermanentDeleteAccount:"アカウント名 <b>{}</b>、アカウント所有者ID <b>{}</b> のアカウントを削除しますか？",
      confirmDeleteAccountPrompt1:"アカウントを削除する場合、使用されていないことを確認し" +
      "、下にアカウント名と所有者IDを入力してください。",
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      createAccount: "アカウント: {}, 所有者: {}",
      deleteAccount:"アカウント: {}, 所有者: {}",
