...
export default {
  common: {
    ...
    ownerIdOrName:"ID ou nom du propriétaire",
    ...
    accountOwnerId: "ID du propriétaire du compte",
    accountOwnerName: "Nom du propriétaire du compte",
    HPCAI: "HPC & IA",
    quantum: "Quantique",
  ...
  pageComp: {
    ...
    admin: {
      ...
      ImportUsersTable: {
        selectAccount: "Veuillez sélectionner un compte !",
        specifyOwner: "Indiquez un propriétaire pour chaque compte.",
        ...
        selectOwner: "Veuillez sélectionner un propriétaire.",
    ...
    user: {
      ...
      userTable: {
        ...
        blockedExplanation: "Bloqué : L'utilisateur a été bloqué par l'administrateur du compte ou le propriétaire du compte, "
        ...
        cannotRemove: "Impossible de supprimer le propriétaire du compte",
  ...
  component: {
    ...
    deleteModals:{
      ...
      accountsOwnerPrompt: "L'utilisateur <b>{}</b> est le propriétaire des comptes <b>{}</b>." +
      ...
      ownerIdRequired:"Veuillez saisir l'ID du propriétaire du compte",
      invalidAccountNameOrOwnerId: "Le nom du compte ou l'ID du propriétaire saisi ne correspond pas.",
      confirmPermanentDeleteAccount:"Veuillez confirmer si vous souhaitez supprimer le compte portant le " +
      "nom <b>{}</b> et l'ID du propriétaire <b>{}</b>.",
      confirmDeleteAccountPrompt1:"Si vous supprimez le compte, veuillez confirmer qu'il n'est plus utilisé" +
      ", et saisissez ci-dessous le nom du compte et l'ID du propriétaire.",
    ...
    tenant: {
      ...
      accounts: {
        ...
        create: {
          ...
          ownerUserId: "ID du propriétaire",
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      createAccount: "Compte : {}, Propriétaire : {}",
      deleteAccount:"Compte : {}, Propriétaire : {}",
