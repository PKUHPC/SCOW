...
export default {
  ...
  pageComp: {
    ...
    admin: {
      ...
      allUserTable: {
        ...
        roles: "플랫폼 역할",
        platformRoleTooltipTitle: "플랫폼 역할 설명",
        platformAdminTooltip: "플랫폼 관리자: 플랫폼 관리 아래의 모든 메뉴 페이지에 대한 조회 및 작업 권한을 가집니다",
        platformFinanceTooltip:
          "플랫폼 재무 담당자: 플랫폼 관리 아래 재무 관리 메뉴의 모든 하위 메뉴 페이지에 대한 조회 및 작업 권한만 가집니다",
    ...
    job: {
      ...
      historyJobTable: {
        ...
        ownerIdOrNamePlaceholder: "주 관리자 ID 또는 이름",
        precision: "정밀 검색",
        platformPrice: "작업 플랫폼 요금",
        tenantPrice: "테넌트 과금",
        jobNumber: "작업 수",
      },
    ...
    tenant: {
      ...
      adminUserTable: {
        allUsers: "전체 사용자",
        tenantAdmin: "테넌트 관리자",
        tenantFinance: "테넌트 재무 담당자",
        idOrName: "사용자 ID 또는 이름",
        name: "이름",
        tenantRole: "테넌트 역할",
        tenantRoleTooltipTitle: "테넌트 역할 설명",
        tenantAdminTooltip: "테넌트 관리자: 테넌트 관리 아래의 모든 메뉴 페이지에 대한 조회 및 작업 권한을 가집니다",
        tenantFinanceTooltip:
          "테넌트 재무 담당자: 테넌트 관리 아래 재무 관리 메뉴의 모든 하위 메뉴 페이지에 대한 조회 및 작업 권한만 가집니다",
    ...
    admin: {
      ...
      systemDebug: {
        ...
        syncClusterAccountUser: {
          ...
          alertInfo:
            "플랫폼은 정기적으로 계정과 사용자 정보를 스케줄러에 동기화합니다. '지금 동기화'를 클릭하여 수동 동기화를 수행할 수 있습니다.",
          maxSyncDurationExplanation:
            "동기화 중에는 플랫폼이 계정 관련 정보를 수정할 수 없습니다. 동기화 시간이 길어져 사용자 경험에 영향을 주지 않도록, 단일 동기화의 최대 처리 시간을 제어하는 파라미터를 제공합니다. 이 시간 제한을 초과하면 현재 동기화가 종료되며, 이미 동기화된 정보는 유지됩니다.",
          syncAlreadyStarted:
        ...
        fetchJobs: {
          ...
          alertMessage:
            "플랫폼은 클러스터에서 작업 정보를 정기적으로 동기화합니다. " +
  ...
  operationLog: {
    ...
    operationTypeTexts: {
      ...
      changeJobPrice: "작업 과금 조정",
      changeJobPlatformPrice: "작업 플랫폼 요금 조정",
    },
    operationDetails: {
      ...
      changeJobPrice: "클러스터: {}, 작업 ID: {}, 가격(CNY): {}",
      changeJobPlatformPrice: "클러스터: {}, 작업 ID: {}, 플랫폼 요금(CNY): {}",
    },
  },
  userRoles: {
    platformAdmin: "플랫폼 관리자",
