...
export default {
  common: {
    ...
    edit: "편집",
    idOrName: "사용자 ID/이름",
    accountOwnerId: "계정 소유자 ID",
    accountOwnerName: "계정 소유자 이름",
    HPCAI: "HPC&AI",
    quantum: "양자",
  ...
  pageComp: {
    ...
    user: {
      ...
      userTable: {
        ...
        blockedExplanation: "차단됨: 계정 관리자 또는 계정 소유자에 의해 사용자가 차단되어 이 계정을 선택해 작업 제출이 불가능합니다.",
        ...
        cannotRemove: "계정 소유자는 제거할 수 없습니다",
  ...
  component: {
    ...
    deleteModals:{
      ...
      deleteFailed: "삭제 실패",
      accountsOwnerPrompt: "사용자 <b>{}</b>는 계정 <b>{}</b>의 소유자입니다. " +
      ...
      ownerIdRequired:"계정 소유자 ID를 입력하세요",
      invalidAccountNameOrOwnerId: "입력한 계정 이름 또는 소유자 ID가 일치하지 않습니다",
      confirmPermanentDeleteAccount:"계정 이름 <b>{}</b>, 계정 소유자 ID <b>{}</b>의 계정을 삭제하시겠습니까?",
      confirmDeleteAccountPrompt1:"계정을 삭제하는 경우, 더 이상 사용 중이 아닌지 확인하시고 " +
      "아래에 계정 이름과 소유자 ID를 입력하세요.",
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      createAccount: "계정: {}, 소유자: {}",
      deleteAccount:"계정: {}, 소유자: {}",
