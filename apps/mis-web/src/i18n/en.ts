export default {
  ...
  operationLog: {
    ...
    operationDetails: {
      ...
      createImage: "Cluster: {}, ImageId: {}, Tag: {}",
      updateImage: "ImageId: {}",
      shareImage: "ImageId: {}",
      deleteImage: "ImageId: {}",
      copyImage: "Source ImageId: {}, Target ImageId: {}, Tag: {}",
      createDataset: "Cluster: {}, DatasetId: {}",
      updateDataset: "DatasetId: {}",
      deleteDataset: "DatasetId: {}",
      createDatasetVersion: "DatasetId: {}, DatasetVersionId: {}",
      updateDatasetVersion: "DatasetId: {}, DatasetVersionId: {}",
      shareDatasetVersion: "DatasetId: {}, DatasetVersionId: {}",
      copyDatasetVersion: "Source DatasetId: {}, Source VersionId: {}; Target DatasetId: {}, VersionId: {}",
      deleteDatasetVersion: "DatasetId: {}, DatasetVersionId: {}",
      createAlgorithm:"Cluster: {}, AlgorithmId: {}",
      updateAlgorithm:"AlgorithmId: {}",
      deleteAlgorithm:"AlgorithmId: {}",
      createAlgorithmVersion:"AlgorithmId: {}, AlgorithmVersionId: {}",
      updateAlgorithmVersion:"AlgorithmId: {}, AlgorithmVersionId: {}",
      shareAlgorithmVersion:"AlgorithmId: {}, AlgorithmVersionId: {}",
      deleteAlgorithmVersion:"AlgorithmId: {}, AlgorithmVersionId: {}",
      copyAlgorithmVersion: "Source AlgorithmId: {}, Source VersionId: {}; Target AlgorithmId: {}, VersionId: {}",
      createModel:"Cluster: {}, ModelId: {}",
      updateModel:"ModelId: {}",
      deleteModel:"ModelId: {}",
      createModelVersion:"ModelId: {}, ModelVersionId: {}",
      updateModelVersion:"ModelId: {}, ModelVersionId: {}",
      shareModelVersion:"ModelId: {}, ModelVersionId: {}",
      deleteModelVersion:"ModelId: {}, ModelVersionId: {}",
      copyModelVersion: "Source ModelId: {}, Source VersionId: {}; Target ModelId: {}, VersionId: {}",
      createUser: "User: {}",
      deleteUser: "User: {}",
