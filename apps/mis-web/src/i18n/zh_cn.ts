export default {
  common: {
    ...
    edit: "编辑",
    idOrName: "用户ID/姓名",
    accountOwnerId: "账户主管理员ID",
    accountOwnerName: "账户主管理员姓名",
    HPCAI: "超智算",
    quantum: "量子计算",
    ...
    directoryServiceNotConfigured: "目录服务未配置，请联系管理员",
    groupNameResolutionFailed: "无法从 LDAP 获取纯数字组名对应的 gid。",
  },
  dashboard: {
    title: "仪表盘",
    account: {
  ...
  pageComp: {
    accounts: {
      accountTable: {
        ...
        deleteDirectoryGroupFailed: "删除账户时目录服务操作失败，请联系管理员",
      },
    ...
    admin: {
      ...
      allUserTable: {
        ...
        roles: "平台角色",
        platformRoleTooltipTitle: "平台角色说明",
        platformAdminTooltip: "平台管理员：拥有平台管理下所有菜单页面的查看和操作权限",
        platformFinanceTooltip: "平台财务人员：只拥有平台管理下财务管理菜单中所有子菜单页面的查看和操作权限",
        notExist: "用户不存在",
      ...
      ImportUsersTable: {
        ...
        quotaEnabling: "账户存储配额正在开启中，请稍后再导入。",
        multiAccountUsers: "以下用户将属于多个账户，无法导入：{}",
        multiGroupUsers: "以下用户属于多个用户组，请确保所有用户仅属于一个用户组后再导入：{}",
        defaultGroupNotRemoved: "以下用户无法确定默认用户组，导入失败，请检查目录服务配置后重试：{}",
        importSuccess: "导入成功",
        selectCluster: "集群:",
        alreadyExist: "账户已经存在于SCOW中",
        notExist: "账户不存在于SCOW中，将会导入SCOW",
        partNotExist: "账户中部分用户不存在于SCOW中，将会导入新的用户",
        selectOwner: "请选择一个主管理员",
        importStatus: "导入状态",
        alreadyImport: "已导入",
    ...
    commonComponent: {
      ...
      paymentTable: {
        ...
        accountHolder: "账户主管理员",
        accountHolderPlaceholder: "主管理员ID或姓名",
        operator: "操作员",
        operatorPlaceholder: "操作员ID或姓名",
        topUpTime: "充值时间",
        yuan: "元",
      },
      billTable: {
      ...
      appAuthorization: {
        appAuthorizationTable: {
          ...
          account: "账户",
          accountOwner: "账户主管理员",
          accountOwnerPlaceholder: "主管理员ID或姓名",
    ...
    init: {
      initAdminForm: {
        ...
        existText:
          "用户已经在认证系统中存在，您此处输入的密码将会不起作用，新用户的密码将是认证系统中的已有用户的当前密码。确认添加为初始管理员？",
      ...
      initImportUsersTable: {
        ...
        useMore:
          "如果您使用SCOW管理多个集群，SCOW系统要求多个集群具有完全相同的用户账户信息，您只需要从一个集群中导入已有用户信息即可。",
      },
      initJobBillingTable: {
    ...
    job: {
      ...
      historyJobTable: {
        ...
        batchSearch: "批量搜索",
        jobEndTime: "作业结束时间",
        userIdOrNamePlaceholder: "用户ID或姓名",
        ownerIdOrNamePlaceholder: "账户主管理员ID或姓名",
        precision: "精确搜索",
        platformPrice: "作业平台费用",
        tenantPrice: "租户计费",
        jobNumber: "作业数量",
      },
    ...
    tenant: {
      ...
      adminJobTable: {
        ...
        userIdOrNamePlaceholder: "用户ID或姓名",
        ownerIdOrNamePlaceholder: "账户主管理员ID或姓名",
        adjustTenantPrice: "批量修改作业计费",
        adjustPrice: "批量修改{}",
        tenantPrice: "作业计费",
        platformPrice: "作业平台费用",
        jobNumber: "作业数量：",
        tenantPriceSum: "作业计费合计：",
        platformPriceSum: "作业平台费用合计：",
        searchTypePlaceholder: "多个请用逗号隔开",
        onlyNumbersAndCommas: "只能包含数字和逗号",
        allTenants: "所有租户",
      },
      adminUserTable: {
        allUsers: "所有用户",
        tenantAdmin: "租户管理员",
        tenantFinance: "租户财务人员",
        idOrName: "用户ID或者姓名",
        name: "姓名",
        tenantRole: "租户角色",
        tenantRoleTooltipTitle: "租户角色说明",
        tenantAdminTooltip: "租户管理员：拥有租户管理下所有菜单页面的查看和操作权限",
        tenantFinanceTooltip: "租户财务人员：只拥有租户管理下财务管理菜单中所有子菜单页面的查看和操作权限",
      ...
      jobPriceChangeModal: {
        ...
        currentPrice: "当前{}",
        job: "作业",
        jobSummaryEllipsis: "等{}个作业",
        priceSummaryEllipsis: "等{}个值",
        annotation:
          "新计费 > 当前计费时需要补扣差额部分，可在账户消费记录中查看；新计费 < 当前计费时会退款差额部分，可在账户充值记录中查看",
      },
      tenantSelector: {
        fresh: "刷新租户列表",
      },
      ...
      defaultApps: {
        defaultAppsTable: {
          ...
          removeFromDefaultApps: {
            title: "移出默认授权应用",
            confirmWarn: "移出默认授权应用后，本租户下所有账户均同步取消该应用的授权",
            removeSuccessMessage: "已从默认授权应用下移出",
            removeFailedMessage: "默认授权应用移出失败",
          },
          addToDefaultApps: {
            title: "添加默认授权应用",
            confirmWarn: "添加为默认授权应用后，本租户下所有账户均同步添加该应用的授权",
    ...
    user: {
      addUserButton: {
        ...
        addSuccess: "添加成功！",
        directoryGroupAddFailed: "用户加入账户用户组失败，请稍后重试",
        userDeleted: "该用户已删除，无法添加",
        userAlreadyInAnotherAccount: "该用户已属于其他账户，不可添加到此账户",
        quotaEnabling: "账户存储配额功能正在启用中，请稍后重试",
      },
      createUserForm: {
        email: "邮箱",
        password: "密码",
      ...
      jobChargeLimitModal: {
        setSuccess: "设置成功",
        batchSetSuccess: "批量设置限额成功",
        batchLimitCompleted: "批量设置限额完成，其中 {} 操作失败",
        ...
        cancelSuccess: "取消限额成功！",
        batchCancelSuccess: "批量取消限额成功！",
        cancelLimited: "取消限额",
        unset: "未设置",
        changeLimited: "修改限额至",
        setLimited: "设置限额",
        batchChangeLimiteFailed: "批量修改限额失败",
        changeLimiteFailed: "修改限额失败",
        batchCleLimiteFailed: "批量取消限额失败",
        cancleLimiteFailed: "取消限额失败",
        andOtherUsers: "等{}个用户",
        andOtherValues: "等{0}个值",
      },
      userTable: {
        block: "封锁",
        blocked: "封锁",
        ...
        blockedExplanation: "封锁：用户已被账户管理员或账户主管理员封锁，无法选择该账户提交作业",
        ...
        batchUnsealCompleted: "批量解除封锁已完成，其中{}操作失败",
        batchUnsealSuccess: "批量解封用户成功！",
        batchUnsealFailed: "批量解封用户失败！",
        batchRemoveCompleted: "批量移出用户操作已完成，其中{}操作失败",
        batchRemoveSuccess: "批量移出用户成功！",
        batchRemoveFailed: "批量移出用户失败！",
        directoryServiceOperationFailed: "目录服务操作失败，请联系管理员",
        andOtherUsers: "等{}个用户",
      },
    ...
    storage: {
      tenantStorageManangerTable: {
        ...
        tenantAssignedQuota: "本租户存储配额",
        tenantAssignedQuotaTooltip: "本租户下所有用户的已分配存储配额之和",
        tenantUsedStorage: "本租户使用量",
        tenantUsedStorageTooltip: "本租户下所有用户的存储使用量之和",
        mountedClusters: "挂载集群",
        edit: "修改",
        user: "用户",
        storageQuota: "存储配额",
        storageUsed: "已使用量",
      ...
      userDefaultQuotaChangeModal: {
        ...
        confirm: "确定",
        modifyUserDefaultQuotaSuccess: "修改用户默认存储配额成功",
      ...
      tenantAccountStorageManagerTable: {
        noStorageConfig: "未找到开启了配额管理的存储系统",
        totalStorage: "总存储量",
        remainingStorage: "剩余量",
        accountDefaultQuota: "账户默认存储配额",
        mountedClusters: "挂载集群",
        account: "账户",
        owner: "主管理员",
        storageQuota: "存储配额",
        storageQuotaTooltip:
          "账户内所有用户共用的总存储配额。用户的可用存储空间同时受到用户存储配额和账户存储配额控制。",
        usedStorage: "已使用量",
        usedStorageTooltip: "账户内所有用户的存储使用量之和。",
        operation: "操作",
        modifyQuota: "修改配额",
        edit: "修改",
        lastSyncTime: "存储使用量更新于",
        ...
        syncSuccess: "更新成功",
        syncFailed: "更新失败",
        batchModifyQuota: "批量修改账户配额",
      },
      accountQuotaChangeModal: {
        modifyStorageQuota: "修改账户存储配额",
        batchModifyStorageQuota: "批量修改账户存储配额",
        confirm: "确定",
        modifySuccess: "修改账户存储配额成功",
        modifyFailed: "修改账户存储配额失败，请稍后重试",
        batchModifySuccess: "批量修改账户存储配额成功",
        batchModifyFailed: "批量修改账户存储配额失败，请稍后重试",
        batchModifyPartialSuccess: "批量修改账户存储配额成功 {} 个，失败 {} 个",
        accountNotFound: "账户 {} 不存在",
        featureNotEnabled: "账户存储配额功能未开启",
        account: "账户",
        selectedAccounts: "选中账户",
        storageSystem: "文件系统",
        currentUsage: "当前已使用量",
        storageQuota: "存储配额",
        defaultStorageQuota: "默认存储配额",
        setStorageQuota: "设置存储配额",
        tip: "修改后立即生效，如果减少配额可能会导致账户存储额度用满，正在运行的作业无法写入数据，请谨慎操作",
        useDefaultValue: "使用默认值",
        useDefaultStorageQuota: "使用默认存储配额",
        confirmUseDefaultStorageQuota: "确认将该账户的存储配额重置为跟随默认值？",
        batchUseDefaultStorageQuota: "批量使用默认存储配额",
        confirmBatchUseDefaultStorageQuota: "确认将选中账户的存储配额重置为跟随默认值？",
        quotaMustBePositive: "存储配额必须大于 0",
      },
      accountDefaultQuotaChangeModal: {
        modifyDefaultQuota: "修改账户默认存储配额",
        confirm: "确定",
        modifySuccess: "修改账户默认存储配额成功",
        modifyFailed: "修改账户默认存储配额失败，请稍后重试",
        quotaExceedsLimit: "存储配额超出文件系统总容量",
        modifyPartialSuccess: "修改成功，{} 等 {} 个账户调整配额时出现异常",
        fileSystem: "文件系统",
        tip: "修改后立即生效，将应用于所有未单独设置配额的账户，请谨慎操作",
        quotaMustBePositive: "存储配额必须大于 0",
      },
    },
    quantumJob: {
  ...
  component: {
    ...
    deleteModals: {
      ...
      deleteFailed: "删除失败",
      accountsOwnerPrompt: "用户<b>{}</b>是账户<b>{}</b>的主管理员，您需要先删除以上账户后才能删除该用户",
      ...
      ownerIdRequired: "请输入账户主管理员ID",
      invalidAccountNameOrOwnerId: "您输入的账户名或账户主管理员ID不匹配",
      confirmPermanentDeleteAccount: "请确认是否删除账户名是<b>{}</b>，账户主管理员ID为<b>{}</b>的账户？",

      confirmDeleteAccountPrompt1: "如果删除账户，请确认该账户已不在使用中，并在下方输入账户名和主管理员ID。",
    ...
    others: {
      ...
      confirmPassword: "确认密码",
      selectCluster: "请选择集群",
      allClustersTooltip: "不指定集群时可查找所有集群（含已经被取消授权的集群）下的作业。",
  ...
  page: {
    ...
    storageBilling: {
      ...
      noAvailableBillingData: "暂无可用计费数据",
      fileSystem: "文件系统：",
      fileSystemTitle: "文件系统",
      all: "全部",
      setStoragePrice: "设置存储价格",
      newBillingId: "新计费编号：",
      generatedAfterSave: "保存后自动生成",
      billingMode: "计量方式",
      billingId: "计费编号",
      selectBillingMode: "请选择计量方式",
      usage: "使用量",
      quota: "配额",
      quotaModeRequiresAccountStorageQuota: "账户存储配额功能未开启，不能选择按配额计费",
      unknown: "未知",
      startValue: "起始值",
      endValue: "结束值",
      unitPrice: "单价(元/TB/天)",
      required: "必填",
      setLastTierEndFirst: "请先设置当前最后一个阶梯的结束值",
      endMustGreaterThanStart: "结束值必须大于起始值",
      lastTierMustBeNoLimit: "最后一个阶梯的结束值必须为不限制",
      add: "新增",
      setPriceSuccess: "价格设置成功",
      saveFailed: "保存失败",
      save: "保存",
      collapseHistory: "收起历史",
      expandHistory: "展开历史",
      historyBillingId: "历史计费编号",
      effectiveDate: "生效日期",
      validPeriod: "有效期",
      timeRange: "{} 至 {}",
    },
    tenant: {
      ...
      accounts: {
        ...
        create: {
          ...
          directoryGroupNameOccupied: "该账户名对应的用户组已存在，请更换账户名",
          userIdAndNameNotMatch: "用户ID和名字不匹配。",
          createSuccess: "创建成功！",
          ownerUserId: "主管理员用户ID",
          ownerName: "主管理员姓名",
          remark: "备注",
          createAccount: "创建账户",
          createAccountFailed: "创建账户失败",
          ownerAlreadyInAnotherAccount: "该用户已属于其他账户，不可作为新账户的主管理员",
    ...
    admin: {
      ...
      accountStorageQuota: {
        pageTitle: "账户存储配额",
        description:
          "账户存储配额可设置账户内所有成员共用的存储额度。开该功能后，用户的存储空间同时受到用户和账户两个维度的存储额度控制。",
        descriptionNote: "只有用户-账户模型是单账户模式（即一个用户最多同时属于一个账户）时才支持开启该功能。",
        switchLabel: "账户存储配额",
        enableConfirmTitle: "启用账户存储配额",
        enableConfirmContent:
          "启用账户存储配额功能需要将用户家目录和所有存储下的个人目录下的文件所属用户组修改为当前所属用户组，" +
          "启用后无法被关闭且数据不可回退，请确认您已充分评估业务影响。",
        initializingBase: "数据初始化中，请稍后",
        initFailTitle: "初始化失败",
        initFailContent: "账户存储配额初始化失败，您可以尝试重新开启。",
        userGroupNotEnabledError: "用户组功能未完成初始化，请先完成用户组初始化后再启用账户存储配额。",
        alreadyEnabledError: "账户存储配额功能已开启或正在开启中。",
        multiAccountUsersError: "以下用户属于多个账户，请确保所有用户仅属于一个账户后再启用：{0}",
        multiGroupUsersError: "以下用户属于多个用户组，请确保所有用户仅属于一个用户组后再启用：{0}",
        defaultGroupNotRemovedError: "以下用户无法确定默认用户组，启用失败，请检查目录服务配置后重试：{0}",
        successTitle: "账户存储配额功能开启成功",
        successContent: "账户存储配额功能已开启生效。点击确认后该配置页面将自动隐藏，无需再次配置。",
        cancel: "取消",
        confirmEnable: "确认启用",
        confirm: "确认",
      },
      ...
      systemDebug: {
        ...
        fetchJobs: {
          ...
          syncJobNow: "立刻同步作业",
          accountUserSyncRunning: "账户用户信息正在执行同步。" + "请等待该同步执行完成后，再重新同步作业信息。",
        },
        userGroup: {
          title: "用户组",
          alertLine1:
            "启用用户组功能后，系统将自动完成存量数据初始化，为每个账户分配独立用户组，账户下所有用户均归属于对应用户组。",
          alertLine2: "本功能为底层核心功能，启动后无法被关闭，数据不可回退，请务必在确认业务需要后再操作。",
          featureLabel: "用户组功能",
          confirmTitle: "启用用户组功能确认",
          confirmContent: "该操作将启用用户组功能，启用后无法被关闭且数据不可回退，请确认您已充分评估业务影响。",
          confirmOk: "确认启用",
          confirmCancel: "取消",
          successTitle: "用户组功能开启成功",
          successContent: "用户组功能已开启生效。点击确认后该配置页面将自动隐藏，无需再次配置。",
          successOk: "确认",
          initializingMessage: "数据初始化中，请稍后......",
          initFailedMessage: "初始化失败，请稍后重试",
        },
      },
      resourceManagement: {
        clusterManagement: {
  ...
  operationLog: {
    ...
    operationTypeTexts: {
      ...
      syncTenantAccountsStorageUsage: "同步租户下账户存储使用情况",
      batchSetAccountStorageQuota: "批量修改账户存储配额",
      setAccountDefaultStorageQuota: "设置账户默认存储配额",
      authorizeApp: "授权应用",
      ...
      changeJobPrice: "修改作业费用",
      changeJobPlatformPrice: "修改作业平台费用",
    },
    operationDetails: {
      submitJob: "集群: {}, 作业ID: {}",
      endJob: "集群: {}, 作业ID: {}",
      ...
      createAccount: "账户: {}, 主管理员: {}",
      deleteAccount: "账户: {}, 主管理员: {}",
      ...
      setTenantUserQuota: "用户: {0}, 文件系统: {1}, 存储配额: {2}",
      batchSetTenantUsersQuota: "用户: {0}, 文件系统: {1}, 存储配额: {2}",
      setTenantUserDefaultQuota: "租户: {0}, 文件系统: {1}, 存储配额: {2}",
      batchSetAccountStorageQuota: "账户: {0}, 文件系统: {1}, 存储配额: {2}",
      setAccountDefaultStorageQuota: "文件系统: {0}, 默认存储配额: {1}",
      syncTenantUsersStorageUsage: "租户: {0}, 文件系统: {1}",
      syncTenantAccountsStorageUsage: "租户: {0}, 文件系统: {1}",
      hpcAppScope: "超算",
      aiAppScope: "智算",
      tenantAppAuthorizationLog: "集群: {0}, 应用: {1}（{3}）, 租户: {2}",
      accountAppAuthorizationLog: "集群: {0}, 应用: {1}（{3}）, 账户: {2}",
      migrateNode: "节点: {}, 源集群: {}, 目标集群: {}",
      activateNode: "节点: {}, 集群: {}",
      updateDefaultApp: "集群: {0}, 应用: {1}（{3}）, 租户: {2}",
      ...
      changeJobPrice: "集群: {}, 作业ID: {}, 计费(元): {}",
      changeJobPlatformPrice: "集群: {}, 作业ID: {}, 平台费用(元): {}",
    },
  },
  userRoles: {
    platformAdmin: "平台管理员",
