    ...
    admin: {
      ...
      systemDebug: {
        ...
        syncClusterAccountUser: {
          ...
          syncDetailsContent: {
            allSuccessfulMessage: "在线集群均同步完成",
            ...
            syncCountDetails: "共有 {0} 条差异数据需同步，成功 {1} 条，",
            syncFailedCount: "失败 {} 条",
            syncTotallySucceed: "数据已完全同步，共完成 {} 条差异数据同步",
            failedDetailDrawerTitle: "同步失败详情",
            noSyncDetailsException: "数据异常，未取得同步数据",
            timeoutException: "数据部分同步（同步超时），",
            syncDetailsWhenTimeout: "已完成 {} 条差异数据同步",
          },
        },
        fetchJobs: {
          jobInfoSync: "作业信息同步",
