...
[root@crane01 scow-adapters]# make build-crane-ai 
...
scp -f scow-crane-ai-adapter config/crane-ai/config.yaml config/crane-ai/adapter.service crane_mn:/adapter     
