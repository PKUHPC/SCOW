...
type FileTransferServer struct {
	transferTaskManager *file_transfer.TaskManager
}

func NewFileTransferServer(manager *file_transfer.TaskManager) *FileTransferServer {
...
func (s *FileTransferServer) StartFileTransfer(ctx context.Context,
	...
	// 创建文件传输任务并添加到任务管理器
	task := file_transfer.NewFileTransfer(
