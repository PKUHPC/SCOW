...
import (
	...
	"scowd/internal/proxy"
	"scowd/pkg/config"
	"scowd/pkg/httpserver"
	"scowd/pkg/libs/db"
	logger "scowd/pkg/logger"
	childProcess "scowd/pkg/process/child"
	"scowd/pkg/tls"
	"scowd/pkg/utils/binary"
...
func main() {
	...
	fileTransferManager, err := file_transfer.NewTaskManager(10, scowdConfig.ServerTLS)
	if err != nil {
