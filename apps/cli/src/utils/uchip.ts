  ...
  const filesToWrite = [
    {
      name: "t12.pragma",
      content:
        "#pragma qubits.mapping [[0,11],[1,0],[2,2],[3,1]," + "[4,12],[5,10],[6,3],[7,4],[8,6],[9,8],[10,9],[11,5]]",
    },
    {
      name: "t12v5.pragma",
    ...
    },
    {
      name: "t57.pragma",
      content:
        "#pragma qubits.mapping [[0,50],[1,40],[2,30],[3,20],[4,10],[5,0]," +
    ...
    },
    {
      ...
      content:
        "#pragma qubits.mapping [[0,4],[1,9],[2,0],[3,5],[4,10],[5,1],[6,6]," +
        "[7,11],[8,2],[9,7],[10,12],[11,3],[12,8],[13,13]]",
    },
    {
      name: "t57v13s4.pragma",
      content:
        "#pragma qubits.mapping [[0,5],[1,10],[2,0],[3,6],[4,11],[5,1],[6,7]," +
        "[7,12],[8,2],[9,8],[10,13],[11,9],[12,4]]",
    },
    {
      name: "t57v15s3.pragma",
      content:
        "#pragma qubits.mapping [[0,10],[1,0],[2,5],[3,11],[4,1],[5,6],[6,12]," +
